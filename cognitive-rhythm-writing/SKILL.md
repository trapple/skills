...
description: Japanese writing rules for designing cognitive rhythm (緩急) in explanatory prose — treating pacing not as decoration but as switching of the reader's cognitive modes (observe → waver → assert → re-examine) and management of unresolved tension. Covers sentence beats, paragraph density waveforms, section openings, telling slack from filler, and a mechanical post-writing inspection procedure. Companion layer on top of japanese-tech-writing. Use when writing chapters, articles, or explanations meant to be read as engaging prose, when diagnosing or fixing dense-but-flat writing, or when user says "認知リズム", "緩急をつけて", "平坦で退屈", "リズムを設計", or "cognitive-rhythm-writing".
---

# 認知リズムを生むための日本語ライティング規範

> **出典**: 本スキルの規範本文は k16shikano (Keiichiro Shikano) 氏の gist
> <https://gist.github.com/k16shikano/eb2929f13ed19c97188393d297be8432> から拝借したものです。
> 原著者は [public gist 全体に Unlicense を適用する旨を宣言](https://gist.github.com/k16shikano/67625f2a7d96e3bbdfae8d571a936063)しています（パブリックドメイン相当）。
