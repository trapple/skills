...
description: Japanese technical-writing style rules for drafting and revising technical manuscripts (book chapters, articles, explanations) — formatting, paragraph/argument construction, argument rigor, reader-load management, viewpoint and narration, restraint of dramatization, banning LLM-ish filler phrases, and redundancy elimination. Use when writing, revising, or rewriting Japanese technical prose, or when user says "執筆規範", "文章規範", "技術文書の推敲", "推敲して", "リライトして", or "japanese-tech-writing".
---
